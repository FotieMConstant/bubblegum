<template>
  <div>
    ...
    <div
      ...
      class="text-left hs-overlay hs-overlay-open:translate-x-0 -translate-x-full duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-slate-700 dark:[&::-webkit-scrollbar-thumb]:bg-slate-500 dark:bg-slate-900 dark:border-gray-700"
    >
      <nav
      ...
      >
        <div class="flex items-center justify-between pt-4 pe-4 ps-7">
          ...
          <router-link
            to="/"
            class="text-xl font-bold bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent"
          >
            BubbleGum
          </router-link>
          <!-- End Logo -->
        ...
        <div class="mt-auto">
          <div class="py-2.5 px-7 flex justify-between">
            ...
            <!-- settings icon -->
            <svg
              class="flex-shrink-0 w-4 h-4 cursor-pointer text-sm rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
              viewBox="0 0 24 24"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
